...
import "~/assets/css/pages/home/realisations/_realisations-list.scss";
...
watch(
    ...
    (newRealisations) => {
      cardStyles.length = 0;
      newRealisations.forEach((realisation, index) => {
...
function swipe(e) {
  initCurrentCard(e.target.closest(".realisation")).then(() => {
    if (currentCard.value) {
      ...
      realisations.value.forEach((realisation) => {
        realisation.display = false;
      })
      ...
      >
        <div class="realisation__container">
          ...
          <img
              ...
              :src="`/realisations/${realisation.image}.webp`"
              :alt="realisation.title"
              draggable="false"
          />
          <button
              class="realisation__details-button"
              @click="realisations[index].display = true"
          >
        ...
        <div
          v-show="realisation.display"
          class="realisation__popup"
        >
          <div class="realisation__popup-content">
            <button @click="realisations[index].display = false">
            ...
            <p class="realisation__description" v-html="realisation.description"></p>
            <p class="realisation__technologies">
              <span
                  v-for="(technology, index) in realisation.technologies"
                  :key="technology"
